...
alloc_error:
    ...
    op->cl_nprivates = 0;
    /* initiate at 0 as default, will change to proper value in ceval.c */
...
PyInstance_NewRaw(PyObject *klass, PyObject *dict)
{
    ...
    inst->in_dict = dict;
    inst->in_privates = PyTuple_New((Py_ssize_t) inst->in_class->cl_nprivates);
    int offset;
    for (offset = 0;offset < inst->in_class->cl_nprivates; offset++){
      PyTuple_SetItem(inst->in_privates, offset, Py_None);
    }
